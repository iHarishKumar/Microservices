...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Harish", "www.harishgunjalli.com", "gharishkumar.2023@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(
			"Harish Documentation", "Harish Documentation", "1.0", "urn:tos",
